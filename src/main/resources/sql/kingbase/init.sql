...
COMMENT ON COLUMN "public"."jelly_inform"."id" IS '主键';
COMMENT ON COLUMN "public"."jelly_inform"."company_id" IS '公司id';
COMMENT ON COLUMN "public"."jelly_inform"."type" IS '类型(1:word;2:excel;)';
COMMENT ON COLUMN "public"."jelly_inform"."code" IS '编码';
COMMENT ON COLUMN "public"."jelly_inform"."name" IS '名称';
COMMENT ON COLUMN "public"."jelly_inform"."data_source" IS '数据源';
COMMENT ON COLUMN "public"."jelly_inform"."template_source" IS '模板源';
COMMENT ON COLUMN "public"."jelly_inform"."create_time" IS '创建时间';
...
COMMENT ON COLUMN "public"."jelly_form_design"."id" IS '主键';
COMMENT ON COLUMN "public"."jelly_form_design"."company_id" IS '公司id';
COMMENT ON COLUMN "public"."jelly_form_design"."type" IS '类型(1:简化版;2:高级版;)';
COMMENT ON COLUMN "public"."jelly_form_design"."name" IS '名称';
COMMENT ON COLUMN "public"."jelly_form_design"."excel_json" IS 'excel配置';
COMMENT ON COLUMN "public"."jelly_form_design"."data_source" IS '数据源配置';
COMMENT ON COLUMN "public"."jelly_form_design"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."jelly_form_design"."update_time" IS '更新时间';
COMMENT ON TABLE "public"."jelly_form_design" IS '表单设计';
...
COMMENT ON COLUMN "public"."jelly_print"."data_source" IS '数据源配置';
...
COMMENT ON COLUMN "public"."jelly_business_table"."is_virtual" IS '虚拟(1:是;0:否;)';
...
COMMENT ON COLUMN "public"."jelly_job"."script" IS '规则';
...
DROP TABLE IF EXISTS "public"."jelly_file_chunk";
CREATE TABLE "public"."jelly_file_chunk"  (
   "id" BIGSERIAL PRIMARY KEY NOT NULL,
...
COMMENT ON COLUMN "public"."jelly_file_chunk"."id" IS '主键';
COMMENT ON COLUMN "public"."jelly_file_chunk"."chunk_number" IS '前分片，从1开始';
COMMENT ON COLUMN "public"."jelly_file_chunk"."chunk_size" IS '分片大小';
COMMENT ON COLUMN "public"."jelly_file_chunk"."current_chunk_size" IS '当前分片大小';
COMMENT ON COLUMN "public"."jelly_file_chunk"."total_chunk" IS '总分片数';
COMMENT ON COLUMN "public"."jelly_file_chunk"."identifier" IS '文件标识';
COMMENT ON COLUMN "public"."jelly_file_chunk"."file_name" IS '文件名';
COMMENT ON COLUMN "public"."jelly_file_chunk"."file_type" IS '文件类型(1:minio;2:阿里云)';
COMMENT ON COLUMN "public"."jelly_file_chunk"."relative_path" IS '相对路径';
COMMENT ON COLUMN "public"."jelly_file_chunk"."part_e_tag" IS '分片信息';
COMMENT ON COLUMN "public"."jelly_file_chunk"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."jelly_file_chunk"."update_time" IS '更新时间';
COMMENT ON TABLE "public"."jelly_file_chunk" IS '文件分片';
...
COMMENT ON COLUMN "public"."sea_node"."source" IS '源节点';
...
INSERT INTO "public"."sys_account" VALUES (1, NULL, 'superAdmin', NULL, NULL, '超级管理员', 1, 'e10adc3949ba59abbe56e057f20f883e', NULL, 1, 3, NULL, 0, '2021-07-01 11:51:02', '2021-07-01 11:51:02');
INSERT INTO "public"."sys_account" VALUES (2, NULL, 'admin', NULL, NULL, '管理员', 1, 'e10adc3949ba59abbe56e057f20f883e', NULL, 1, 2, NULL, 0, '2021-07-01 11:51:02', '2021-07-01 11:51:02');
...
select setval('sys_user_relate_id_seq',(select max(id) from "public"."sys_user_relate"));
INSERT INTO "public"."sys_role" VALUES (1, 1, '默认角色', '1,2,3,4', '2021-07-01 11:31:22', '2021-07-01 11:31:22');
select setval('sys_role_id_seq',(select max(id) from "public"."sys_role"));
INSERT INTO "public"."sys_menu" VALUES (1, 1, NULL, 5, '组织架构', 'el-icon-office-building', NULL, 1, 1, NULL, '2021-07-01 11:33:27', '2021-07-01 11:33:27');
INSERT INTO "public"."sys_menu" VALUES (2, 1, 1, 4, '通讯录', 'el-icon-collection', 'contact', 1, 1, NULL, '2021-07-01 11:34:04', '2021-07-01 11:34:04');
INSERT INTO "public"."sys_menu" VALUES (3, 1, 1, 4, '角色管理', 'el-icon-coin', 'role', 1, 2, NULL, '2021-07-01 11:34:38', '2021-07-01 11:34:38');
