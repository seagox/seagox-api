...
public class TencentUtils {
     ...
     * SDK_APP_ID
     */
    public static final Long SDK_APP_ID = 1400689406L;

    /**
     * KEY
     */
    public static final String KEY = "a92c4b8f83b997c745514228336070bd5f33c00d0454eb4f7c577919bc76756a";
    
    
    public static JSONObject getURLContent(String address) {
    	try {
    		String addressEncode = URLEncoder.encode(address, "utf-8");
            String urlStr = "https://apis.map.qq.com/ws/geocoder/v1/?address=" + addressEncode + "&key=LYRBZ-HXU6W-EBSRI-OV7CM-AOGZK-24FUW";
            String response = HttpClientUtils.doGet(urlStr);
    ...
    public byte[] genUserBuf(String account, long dwAuthID, long dwExpTime,
        ...
        */
        ...
        //dwSdkAppid
        userbuf[offset++] = (byte) ((SDK_APP_ID & 0xFF000000) >> 24);
        userbuf[offset++] = (byte) ((SDK_APP_ID & 0x00FF0000) >> 16);
        userbuf[offset++] = (byte) ((SDK_APP_ID & 0x0000FF00) >> 8);
        userbuf[offset++] = (byte) (SDK_APP_ID & 0x000000FF);
