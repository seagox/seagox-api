...
public class WeiChatUtils {
     ...
     * 服务号APPID
     */
    public static final String SERVICE_NUMBER_APPID = "wx5f1e1984780990f0";

    /**
     * 服务号SERCRET
     */
    public static final String SERVICE_NUMBER__SERCRET = "ec7acf40e13e9cbf734d40c005ecd938";
     ...
     * 获取服务号access_token
     */
    public static JSONObject getServiceNumberAccessToken() {
        try {
            String url = ACCESS_TOKEN.replace("APPID", SERVICE_NUMBER_APPID).replace("SECRET", SERVICE_NUMBER__SERCRET);
            String result = HttpClientUtils.doGet(url);
            if (!StringUtils.isEmpty(result)) {
                return JSON.parseObject(result);
            }
