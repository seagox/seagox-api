...
import com.seagull.oa.util.DocumentConverterUtils;
import com.seagull.oa.util.QiyuesuoUtils;
...
public class UploadController {
    ...
    public void documentDownload(HttpServletResponse response, String documentId) {
        QiyuesuoUtils.documentDownload(response, documentId);
    }
