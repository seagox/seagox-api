...
import com.seagull.oa.exception.ConfirmException;
import com.seagull.oa.exception.FormulaException;
import com.seagull.oa.excel.entity.JellyImportRule;
import com.seagull.oa.excel.mapper.JellyImportRuleDetailMapper;
import com.seagull.oa.excel.mapper.JellyImportRuleMapper;
import com.seagull.oa.flow.entity.SeaInstance;
import com.seagull.oa.flow.mapper.SeaDefinitionMapper;
import com.seagull.oa.flow.mapper.SeaInstanceMapper;
import com.seagull.oa.flow.mapper.SeaNodeDetailMapper;
import com.seagull.oa.flow.mapper.SeaNodeMapper;
import com.seagull.oa.flow.service.IRuntimeService;
...
import com.seagull.oa.util.ExcelUtils;
import com.seagull.oa.util.ExportUtils;
import com.seagull.oa.util.FormulaUtils;
import com.seagull.oa.util.JdbcTemplateUtils;
	...
	public ResultData importExcel(MultipartFile file, HttpServletRequest request, String ruleId) {
		try {
	        ...
	        if (exportRule.getVerifyRuleId() != null) {
				...
				result = ExcelUtils.readSheet(new ByteArrayInputStream(file.getBytes()), 2, rule, verifyRule.getScript());
	        } else {
				result = ExcelUtils.readSheet(new ByteArrayInputStream(file.getBytes()), 2, rule, null);
	        }
